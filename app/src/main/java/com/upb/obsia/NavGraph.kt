...
import com.upb.obsia.ui.screens.RegisterDetailsScreen
...
fun NavGraph(navController: NavHostController) {
    NavHost(
        ...
        composable(NavRoutes.REGISTER_DETAILS) {
            RegisterDetailsScreen(navController)
        }
        composable(NavRoutes.LOGIN) {
            LoginScreen(navController)
        }
        composable(NavRoutes.LOGIN_DETAILS) {
            LoginDetailsScreen(navController)
        }
        composable(NavRoutes.CHAT_PAGE) {
            ChatPageScreen(navController)
        }
        composable(NavRoutes.CHAT_LIST) {
            ChatListScreen(navController)
        }
        composable(NavRoutes.CHAT_LIST_TAP) {
            ChatListTapScreen(navController)
        }
        composable(NavRoutes.CHAT_SCREEN) {
            ChatScreen(navController)
        }
        composable(NavRoutes.CHAT_SCREEN_TYPING) {
            ChatScreenTypingScreen(navController)
        }
